...
export const curryr = (fn, x) => y => fn(y, x)
...
// -or-
//     liftf(add)(1)(2) -> 3
export const liftf = fn => x => y => fn(x, y)
...
// -or-
//     twice(mul)(6) -> 36
export const twice = fn => x => fn(x, x)
...
// -or-
//     reverse(sub)(3, 6) -> 3
export const reverse = fn => (x, y) => fn(y, x)
...
export const composeu = (fn1, fn2) => x => fn2(fn1(x))
...
export const composeb = (fn1, fn2) => (x, y, z) => fn2(fn1(x, y), z)
